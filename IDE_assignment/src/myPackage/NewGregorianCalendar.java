...
public class NewGregorianCalendar extends GregorianCalendar {
	...
	public String toString() {
		String s = "";
		s += String.format("%4d-%02d-%02d", super.get(Calendar.YEAR),
				super.get(Calendar.MONTH) + 1, super.get(Calendar.DATE));
		if (super.get(Calendar.HOUR_OF_DAY) != 0) {
			s += String.format("T%02d:%02d:%02d\n",
					super.get(Calendar.HOUR_OF_DAY),
					super.get(Calendar.MINUTE), super.get(Calendar.SECOND));
		}
		return s;
	}
	...
	public static void main(String[] args) {
		...
		NewGregorianCalendar gc2 = new NewGregorianCalendar(2010, 2, 2, 14, 2,
				5);
